...
//     if (selectedDocType && !selectedDocuments.includes(selectedDocType)) {
//       setSelectedDocuments([...selectedDocuments, selectedDocType]);
//       setDocumentType(""); // Reset the dropdown after selection
//     }
//   };
...
//   // Handle removal of a document type
...
//           <label className="block mb-2 mt-4">
//             {docType.toUpperCase()} Document Proof
//           </label>
//           <div
//             className={`border-2 rounded-lg flex items-center justify-center h-42 w-42 sm:h-40 sm:w-40 ${
//               documentFiles[docType] ? "border-gray-300" : "border-blue-500"
//             }`}
//           >
//             {documentFiles[docType] ? (
//               <img
//                 src={URL.createObjectURL(documentFiles[docType])}
//                 alt={`Uploaded ${docType} Document`}
//                 className="max-h-full max-w-full object-contain"
//               />
//             ) : (
//               <span className="text-gray-500 text-sm text-center">
...
//           <div className="mt-4 flex space-x-2">
//             <label className="cursor-pointer bg-primary hover:bg-primary-focus text-white font-bold py-2 px-4 rounded">
//               {documentFiles[docType] ? "Change" : "Select Image"}
//               <input
//                 type="file"
//                 accept="image/*"
...
//     {selectedDocuments.map((docType) => (
//       <div key={docType} className="flex items-center bg-gray-200 rounded-full px-2 py-1 mr-2 mb-2">
...
//   {/* Dynamically Render Upload Sections for Selected Documents */}
//   {selectedDocuments.map((docType) => (
//     <div key={docType} className="mt-4">
//       <label className="block mb-2 mt-4">
//         {docType.toUpperCase()} Document Proof
...
const [selectedBranch, setSelectedBranch] = useState<string>("");
 ...
 const [isDropdownOpen, setIsDropdownOpen] = useState(false);
  ...
  const handleDocumentSelection = (selectedOptions) => {
