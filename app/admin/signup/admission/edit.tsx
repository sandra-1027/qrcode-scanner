...
const Edit = ({ showmodal, togglemodal, AdmissionData, onSave }: EditProps) => {
  ...
  const [selectedOption, setSelectedOption] = useState<string>("create");
  const [branch, setBranch] = useState<{ id: string; branch_name: string }[]>([]);
  const [service, setService] = useState<{ id: string; service_name: string; amount: string }[]>([]);
  ...
  const handleBranchSelect = (branch: { id: string; branch_name: string }) => {
    setFormData((prev) => {
      if (!prev) return null;
                  ...
                  <div className="mb-4 mt-4 ">
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 mt-2">
                      ...
                      <label className="block ">
                        ...
                        <span className="relative mt-1.5 flex">
                          ...
                          >
                            <span>{formData?.branch_name || "Select a Branch"}</span>
                          </div>
                    ...
                    <div className="w-full max-w-3xl mx-auto space-y-6">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div>
                          <label className="block mb-2 mt-4">Document Upload</label>
                          <div className="ml-2">
                            {documentPreview ? (
                              <div className="mb-2">
                                <img
