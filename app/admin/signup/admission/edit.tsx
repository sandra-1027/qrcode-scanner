...
<label className="block">
  ...
  <span className="relative mt-1 flex">
                        ...
                        onChange={handleChange}
                        name="type"
                        className="px-5 py-2.5 dark:bg-navy-700 form-input peer mt-1  w-full rounded-lg border border-slate-300 bg-transparent placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent">
