...
const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
  ...
  try {
    ...
    if (!response.ok || responseJson.success === false) {
      const errorMessage = responseJson.msg || "An error occurred";
      const errorDetails = responseJson.error_msgs ? Object.values(responseJson.error_msgs).join(", ") : "";
      toast.error(`${errorMessage}: ${errorDetails}`);
      return;
    }
    if (response.ok) {
    toast.success('License Cost Added successfully');
