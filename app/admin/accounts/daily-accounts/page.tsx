...
//   const [filteredData, setFilteredData] = useState<Account[]>([]);
//   const [expenseData, setExpenseData] = useState<Account | null>(null);
//   const [expenseDatas, setExpenseDatas] = useState<Account | null>(null);
//   const [filteredDatas, setFilteredDatas] = useState<Account[]>([]);
//   const [accountDatas, setAccountDatas] = useState<Account[]>([]);
//   const [ BranchData,  setBranchData] = useState<Account []>([]);
//   const [searchTerm, setSearchTerm] = useState('');
//   const [selectedBranch, setSelectedBranch] = useState<string>("");
//   const [selectedStatus, setSelectedStatus] = useState<string>("");
...
//   useEffect(() => {
//     fetchStaffData();
//   }, [state, selectedDate]); // Add selectedDate to dependencies



//   const fetchStaffaccountData = async () => {
//     try {
//       const response = await fetch('/api/admin/accounts/accounts_details', {
//         method: 'POST',
//         headers: {
...
//           id: null,
//           status: null,
//           date: null, // Use selectedDate here
//         }),
//       });
...
//       if (data.success) {
//         setAccountDatas(data.data.accounts_details);
//         // setFilteredData(data.data.accounts_details);
//         setExpenseDatas(data.data.expenses);
//       }
//     } catch (error) {
//       console.error("Fetch error:", error);
//     }
...
//   const applyFilters = () => {
//     let newFilteredData = accountDatas;
...
//     if (selectedDate) {
//      // console.log(selectedDate,"selectedDate in filter")
//       newFilteredData = newFilteredData.filter((item) => {
//         const itemDate = item.added_date.split(" ")[0]; 
//       //  console.log(itemDate,"itemDate in filter")
