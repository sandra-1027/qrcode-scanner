...
//   // };
//   const handleCommand = (command: string, value?: string) => {
//     editorRef.current?.focus();  // Ensure the editor is focused before executing the command
//     document.execCommand(command, false, value || '');
//     updateToolbarState();
//   };
//   const updateToolbarState = () => {
...
//   contentEditable
//   dir="ltr"
//   className="editor p-4 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-600 rounded-b-lg min-h-[200px]"
//   onInput={handleInput}
//   onKeyDown={handleKeyDown}
//   onClick={handleClickInsideEditor}
// >
